                ...
                <div class="items-container row clearfix">
                    <div
                        ...
                        <div class="place-block-one">
                            <div class="inner-box">
                                <figure class="image-box"><img src="frontend/assets/images/resource/place-1.jpg"
                                        alt=""></figure>
                                <div class="text">
                    ...
                    <div
                        ...
                        <div class="place-block-one">
                            <div class="inner-box">
                                <figure class="image-box"><img src="frontend/assets/images/resource/place-2.jpg"
                                        alt=""></figure>
                                <div class="text">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all illustration marketing logo">
                        <div class="place-block-one">
                            <div class="inner-box">
                                <figure class="image-box"><img src="frontend/assets/images/resource/place-3.jpg"
                                        alt=""></figure>
                                <div class="text">
                    ...
                    <div class="col-lg-8 col-md-6 col-sm-12 masonry-item small-column all brand marketing print software">
                        <div class="place-block-one">
                            <div class="inner-box">
                                <figure class="image-box"><img src="frontend/assets/images/resource/place-4.jpg"
                                        alt=""></figure>
                                <div class="text">
